<script>
import { siteNav } from "../../stores";
</script>


<footer class="text-gray-200 body-font bg-slate-900 mt-12">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap md:text-left text-center order-first">
      {#each siteNav.footerNav.categories as cat}
        <div class="lg:w-1/4 md:w-1/2 w-full px-4" >
          <h2 class="title-font font-medium text-white tracking-widest text-sm mb-3">{ cat.name }</h2>         
